...
function addPersonToTable(gender, age_mostrar_table, sum_partials, suma_con_alquiler) {
    const row = document.createElement("tr");
    row.innerHTML = `<td>${gender}</td><td>${age_mostrar_table}</td><td class="add_Partials">${sum_partials}</td>`;
...
//     let alq1 = parseFloat(document.getElementById("total_alquiler_in").value);
//     let alq2 = parseFloat(document.getElementById("total_alquiler_out").value);

//     console.log("alq1", alq1);
//     console.log("alq2", alq2);

//     if (isNaN(parseFloat(document.getElementById("total_alquiler_out").value))) {
...
function add_person_sum_canasta() {
    document.getElementById("person-form").addEventListener("submit", function (e) {
        ...
        add_partials = 0;
        add_partials = canasta_por_persona;
...
let result_add_person = add_person_sum_canasta();

console.log("canasta_por_persona 8-", canasta_por_persona);
...
document.getElementById("total_alquiler_in").addEventListener("input", () => {
    ...
    if (isNaN(parseFloat(document.getElementById("total_alquiler_out").value))) {
        ...
        document.getElementById("total_alquiler_out").value = total_alquiler_in;
...
function sumar_Personas(suma_de_Personas, total_alquiler_in, total_alquiler_out) {
    console.log("suma_de_Personas", suma_de_Personas);

    age = document.getElementById("selected-age").value;
    // total_alquiler_out ++++++++++++++++++++++++++
    total_alquiler_in = parseFloat(document.getElementById("total_alquiler_in").value);
    total_alquiler_out = document.getElementById("total_alquiler_out").value;
    //suma_Array_Personas.push(canasta_por_persona);

    console.log("total_alquiler_in", total_alquiler_in);
    console.log("total_alquiler_out", total_alquiler_out);
...
sumar_Personas(suma_de_Personas, total_alquiler_in, total_alquiler_out);
